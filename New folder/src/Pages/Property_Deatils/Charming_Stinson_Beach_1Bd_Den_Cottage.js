					...
					<div className="row">
						...
						<div className="col-sm-6">
							<div className="beach-img-box">
								<img src="images/properties_images/11_Sierra/11-Sierra-Cover.png" className="border-rds"/>
							</div>
						</div>
						<div className="col-sm-2">
							<div className="row">
								<div className="col-sm-12 mb-15">
									<div className="beach-img-box">
										<img src="images/properties_images/11_Sierra/11-Sierra-Picture1.jpg" className="border-rds side_image"/>
									</div>
								</div>
								<div className="col-sm-12 mb-15">
									<div className="beach-img-box">
										<img src="images/properties_images/11_Sierra/11-Sierra-Picture2.jpg" className="border-rds side_image"/>
									</div>
								</div>
								<div className="col-sm-12 mb-15">
									<div className="beach-img-box">
										<img src="images/properties_images/11_Sierra/11-Sierra-Picture3.jpg" className="border-rds side_image"/>
									</div>
								</div>
							</div>
						</div>
