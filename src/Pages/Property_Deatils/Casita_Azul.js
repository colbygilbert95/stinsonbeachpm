					...
					<div className="row">
						...
						<div className="col-sm-6">
							<div className="beach-img-box">
								<img src="images/property_images/Casita_Azul/Casita_Azul_22.jpg" className="border-rds"/>
							</div>
						</div>
						<div className="col-sm-2">
							<div className="row">
								<div className="col-sm-12 mb-15">
									<div className="beach-img-box">
										<img src="images/property_images/Casita_Azul/Casita_Azul_Colby_1.jpg" className="border-rds side_image"/>
									</div>
								</div>
								<div className="col-sm-12 mb-15">
									<div className="beach-img-box">
										<img src="images/property_images/Casita_Azul/Casita_Azul_01.jpg" className="border-rds side_image"/>
									</div>
								</div>
								<div className="col-sm-12 mb-15">
									<div className="beach-img-box">
										<img src="images/property_images/Casita_Azul/Casita_Azul_09.jpg" className="border-rds side_image"/>
									</div>
								</div>
							</div>
						</div>
